...
export const CampaignEdit: React.FC = () => {
  ...
  const calculateConversionRate = () => {
    if (!campaignData || campaignData.metrics.contacted === 0) return 0;
    ...
    <Edit saveButtonProps={saveButtonProps}>
      <Form {...formProps} layout="vertical">
        <Row gutter={[16, 16]}>
          ...
          {campaignData && (
            <Col span={24}>
              <Card title="Métricas Actuales" bordered={false}>
                <Row gutter={16}>
                  <Col xs={6}>
                    <Statistic
                      title="Llamadas Totales"
                      value={campaignData.metrics.totalCalls}
                  ...
                  <Col xs={6}>
                    <Statistic
                      title="Contactados"
                      value={campaignData.metrics.contacted}
                      prefix={<UserOutlined />}
                    />
                  </Col>
                  <Col xs={6}>
                    <Statistic
                      title="Conversiones"
                      value={campaignData.metrics.converted}
                      prefix={<UserOutlined />}
                    />
                  </Col>
                  <Col xs={6}>
                    <Statistic
                      title="Ingresos"
                      value={campaignData.metrics.revenue}
                      prefix="$"
                      precision={2}
                    />
                  </Col>
                ...
                <div style={{ marginTop: 16 }}>
                  ...
                  <Progress percent={Number(calculateConversionRate())} />
                </div>
              </Card>
            </Col>
          )}
